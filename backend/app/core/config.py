...
class Settings(BaseSettings):
    ...
    backend_cors_origins: str = "http://localhost:3000,http://localhost:3001,http://127.0.0.1:3000,http://127.0.0.1:3001,http://192.168.1.11:3000,http://192.168.1.11:3001,https://product-intel.vercel.app"
    log_level: str = "INFO"
